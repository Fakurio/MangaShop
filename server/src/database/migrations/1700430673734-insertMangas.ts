  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      INSERT INTO manga (manga_id, title, img_url, price, stock_quantity, author, description) VALUES
       ...
       (10, 'Komi-san wa Komyushou Desu', 'https://uploads.mangadex.org/covers/a96676e5-8ae2-425e-b549-7f15dd34a6d8/f8f44329-1dd7-4301-9ec7-a4a76182e8eb.jpg.256.jpg', 19.99, 20, 'Oda Tomohito', 'Komi-san is a beautiful and admirable girl that no one can take their eyes off of. Almost the whole school sees her as the cold beauty that''s out of their league, but Tadano Hitohito knows the truth: she''s just really bad at communicating with others. Komi-san, who wishes to fix this bad habit of hers, tries to improve it with the help of Tadano-kun by achieving her goal of having 100 friends.'),
