    ...
    <div class="flex justify-evenly items-center mt-5 filters">
      ...
      <div class="flex justify-center items-center gap-4">
        <Select.Root type="single" bind:value={selectedSortFilter}>
          ...
          <Select.Content>
            <Select.Item value={SortFilter.DATE_DESC}
              >{SortFilter.DATE_DESC}</Select.Item
            >
            <Select.Item value={SortFilter.DATE_ASC}
              >{SortFilter.DATE_ASC}</Select.Item
            >
            <Select.Item value={SortFilter.PRICE_DESC}
              >{SortFilter.PRICE_DESC}</Select.Item
            >
            <Select.Item value={SortFilter.PRICE_ASC}
              >{SortFilter.PRICE_ASC}</Select.Item
            >
          </Select.Content>
        </Select.Root>
