<script lang="ts">
    ...
    import {fetchMangaForAdmin, adminMangaStore, adminMangaStoreError} from "../../stores/admin.store";
...
<main class="px-20 py-6">
    ...
    {:then _}
        <DataTable data={$adminMangaStore} columns={adminColumns} searchByColumn="title"/>
    {/await}
